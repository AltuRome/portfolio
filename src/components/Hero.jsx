  ...
  const socialLinks = [
    {
      kind: 'github',
      label: 'GitHub',
      href: 'https://github.com/AltuRome',
    },
    {
      kind: 'linkedin',
      label: 'LinkedIn',
      href: 'https://www.linkedin.com/in/aamil06/',
    },
    {
      kind: 'leetcode',
      label: 'LeetCode',
      href: 'https://leetcode.com/u/chaffyy/',
    },
    {
      kind: 'codeforces',
      label: 'Codeforces',
      href: 'https://codeforces.com/profile/chafAL',
    },
  ];

  return (
    <section id="top" className="hero">
      <div className="container heroContainer heroGrid">
        <div className="heroLeft heroIntro">
          <div className="kicker reveal" data-reveal style={{ '--reveal-delay': '0ms' }}>
            CS Engineering
          </div>

          <h1 className="heroName reveal" data-reveal style={{ '--reveal-delay': '0ms' }}>
            <span className="heroNameBg" aria-hidden="true">
              <svg width="340" height="340" viewBox="0 0 340 340" fill="none">
                <path
                  d="M170 22 L186 54 L220 44 L206 76 L236 98 L202 108 L210 144 L176 132 L170 168 L164 132 L130 144 L138 108 L104 98 L134 76 L120 44 L154 54 Z"
                  stroke="rgba(200,169,110,0.85)"
                  stroke-width="1"
                  opacity="0.6"
                />
                <circle cx="170" cy="170" r="128" stroke="rgba(200,169,110,0.7)" stroke-width="1" opacity="0.5" />
                <circle cx="170" cy="170" r="92" stroke="rgba(200,169,110,0.7)" stroke-width="1" opacity="0.4" />
                <path
                  d="M170 52 V288 M52 170 H288"
                  stroke="rgba(200,169,110,0.65)"
                  stroke-width="1"
                  opacity="0.35"
                />
                <path
                  d="M95 95 L245 245 M245 95 L95 245"
          ...
          <div className="heroRule reveal" data-reveal style={{ '--reveal-delay': '150ms' }} aria-hidden="true">
            <svg width="520" height="34" viewBox="0 0 520 34" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M20 17 H500"
                stroke="rgba(200,169,110,0.75)"
                stroke-width="1.2"
                stroke-linecap="round"
              />
              <path
                d="M256 6 L266 17 L256 28 L246 17 Z"
          ...
          <p className="heroTagline reveal" data-reveal style={{ '--reveal-delay': '300ms' }}>
            CS Engineering student. Building things that think.
          </p>

          <div className="heroLinksRow reveal" data-reveal style={{ '--reveal-delay': '450ms' }}>
            {socialLinks.map((l) => (
              <a
                key={l.kind}
                className="stampLink"
                ...
                rel="noreferrer"
              >
                <span className="stampIcon" aria-hidden="true">
                  <ExternalIcon kind={l.kind} />
                </span>
                <span className="stampLabel">{l.label}</span>
              </a>
            ))}
          </div>

          <div className="heroContact reveal" data-reveal style={{ '--reveal-delay': '600ms' }}>
            <div className="heroContactLine">
          ...
          <div className="heroActions reveal" data-reveal style={{ '--reveal-delay': '720ms' }}>
            <a className="cvButton" href="/resume.pdf" download>
              Download CV
            </a>
          </div>
        </div>
        ...
        <button
          type="button"
          className="scrollIndicator reveal"
          onClick={() => navigate('/about')}
          aria-label="Scroll down"
          data-reveal
          style={{ '--reveal-delay': '820ms' }}
        >
          <span className="scrollIndicatorInner" aria-hidden="true">
            <span className="arrow" />
          </span>
          <span className="scrollText mono">Scroll</span>
        </button>
      </div>
    </section>
  );
